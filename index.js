...
client.on('interactionCreate', async interaction => {
    ...
    if(funny === 'first') {
        ...
        .setDescription("● To get help on a specific command type `@Spoty Music help <command>`!")
        .setColor("#303037")
        .setFooter("Spoty Music", ee.avatara)
        .setTimestamp()
    ...
    if(funny === 'second') {
        ...
        .setDescription("● To get help on a specific command type `@Jazz Music help <command>`!")
        .setColor('#303037')
        .setFooter("Jazz Music", ee.avatara)
        .setTimestamp()
...
client.on('interactionCreate', async interaction => {
    ...
    if(player === undefined) {
        if(interaction.channel.name === 'spoty-requets') {
            setTimeout(() => {
...
client.on('guildCreate', async (guild) => {
  ...
  try {
    ...
    const texts = "Hi, This Is Spoty If You Need Support Related Me Join My Support Server. Support Server Link Is Here https://discord.gg/vampievilla"
