...
module.exports = {
    ...
    let helpmenu = new MessageEmbed()
        .setAuthor(`Jazz Music Help Panel`, ee.footericon)
        .setDescription(`
...
**${emoji.categories.AnimatedDiscord} Help related to Jazz Music's commands**
 ...
 `)
        ...
        .addComponents(
            new MessageSelectMenu()
                .setCustomId('helpop')
                .setPlaceholder('❯ Jazz Music Help Menu!')
                .addOptions([
                {
                ...
                {
                    label: 'Settings',
                    description: 'Jazz Music Settings',
                    value: 'fifth',
